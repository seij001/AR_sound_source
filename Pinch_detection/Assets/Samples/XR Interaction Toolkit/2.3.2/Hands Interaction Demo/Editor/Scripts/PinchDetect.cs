...
public class PinchDetect : MonoBehaviour
{
    ...
    void Start()
    {
        // Create a PinchGestureRecognizer and register it with the ARGestureInteractor.
        pinchRecognizer = new PinchGestureRecognizer();
        GetComponent<ARGestureInteractor>().gestureInteractors.Add(pinchRecognizer);

        // Subscribe to the pinch event.
        pinchRecognizer.onGestureStarted += OnPinchStarted;
        pinchRecognizer.onGestureUpdated += OnPinchUpdated;
        pinchRecognizer.onGestureCompleted += OnPinchCompleted;
        pinchRecognizer.onGestureCanceled += OnPinchCanceled;
    }

    // Event handlers for pinch gestures
    private void OnPinchStarted(PinchGesture gesture)
    {
        Debug.Log("Pinch Started!");
        // Add your pinch started logic here
    }

    private void OnPinchUpdated(PinchGesture gesture)
    {
        Debug.Log("Pinch Updated!");
        // Add your pinch updated logic here
    }

    private void OnPinchCompleted(PinchGesture gesture)
    {
        Debug.Log("Pinch Completed!");
        // Add your pinch completed logic here
    }

    private void OnPinchCanceled(PinchGesture gesture)
    {
        Debug.Log("Pinch Canceled!");
        // Add your pinch canceled logic here
    }

    void OnDestroy()
    {
        // Unsubscribe from pinch events and remove the recognizer.
        pinchRecognizer.onGestureStarted -= OnPinchStarted;
        pinchRecognizer.onGestureUpdated -= OnPinchUpdated;
        pinchRecognizer.onGestureCompleted -= OnPinchCompleted;
        pinchRecognizer.onGestureCanceled -= OnPinchCanceled;
